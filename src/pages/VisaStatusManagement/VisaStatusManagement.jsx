...
export default function VisaStatusManagement() {
  ...
  const [optRecStatus, setOptRecStatus] = useState("approved");
      ...
      <Text italic>Please follow the document order one by one.</Text>
        ...
        <div className={styles.section}>
          ...
          {i983Status === "pending" ? (
            ...
            <Text>HR feedback</Text>
          ) : i983Status === "approved" && eadStatus === "approved" && optRecStatus === "approved"? (
            ...
            <Text>Please wait for the previous document to be approved before you submit i-983.</Text>
          )}
        </div>
