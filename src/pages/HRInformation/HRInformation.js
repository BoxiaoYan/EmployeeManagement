  ...
  const TableRow = (props) => {
    ...
    return (
      <tr>
        ...
        <td>
          <span className="fw-normal">{SSN}</span>
        </td>
        <td>
          <span className="fw-normal">{visa}</span>
        </td>
        <td>
          <span className="fw-normal">{cellPhone}</span>
        </td>
        <td>
        ...
        <div>
          <div className="table-settings">
            <Row
              ...
              className="justify-content-between align-items-center mb-4 pt-4"
            >
          ...
          <Card
            border="light"
            className="table-wrapper table-responsive shadow-sm m-4"
          >
              ...
              <Card.Footer className="px-3 border-0 d-lg-flex align-items-center justify-content-between">
                <Nav>
                  <Pagination className="mb-2 mb-lg-0">
                    ...
                    {Array.from(
                      {
                        length: Math.ceil(displayProfile.length / itemsPerPage),
                      },
                      (value, index) => (
                        <Pagination.Item
                          key={index + 1}
                  ...
                  <b>
                    {Math.min(
                      currentPage !== totalPages
                        ? itemsPerPage
                        : totalDatas % itemsPerPage,
                      displayProfile.length
                    )}
                  </b>{" "}
                  out of <b>{displayProfile.length}</b> entries
                </small>
              </Card.Footer>
            </Card.Body>
          </Card>
