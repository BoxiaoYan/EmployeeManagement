      ...
      {isLoading ? (
        ...
        <div className="onboarding-application">
          ...
          {!is_hr && step === "Rejected" && (
            <>
              <div
                className="custom-textbox-rejected"
                onClick={() => {
          ...
          {!is_hr && step === "Pending" && (
            <div className="custom-textbox-pending">
              This application has been submitted and is currently pending. You
              can download files by clicking those round image areas.
            </div>
          )}
