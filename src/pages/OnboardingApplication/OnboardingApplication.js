...
function OnboardingApplication() {
  ...
  const [birthDate, setBirthDate] = useState(() => {
    ...
    return storedBirthDate !== null
      ? Date.parse(storedBirthDate)
      : new Date(2000, 0, 1);
  });
  ...
  const [startDate, setStartDate] = useState(() => {
    ...
    return storedStartDate !== null
      ? Date.parse(storedStartDate)
      : new Date(2000, 0, 1);
  });
  const [endDate, setEndDate] = useState(() => {
    const storedEndDate = localStorage.getItem("endDate");
    return storedEndDate !== null
      ? Date.parse(storedEndDate)
      : new Date(2000, 0, 1);
  });
  ...
  const onF1Drop = (e) => {
    ...
    if (file.size / 1024 / 1024 >= 3) {
      ...
      reader.readAsDataURL(file);
      reader.onload = async () => {
        console.log("F1 Receipt Base64:", reader.result);
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        if (localStorage.getItem("appStatus") === "Rejected") {
          console.log(
            "Success in resubmitting the profile:",
            response.data.message
          );
          localStorage.setItem("userStatus", "Pending");
          setStep("Pending");
      ...
      console.log("F1 Base64 is: ", F1Base64);
  ...
  const handleApprove = async () => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:8080/api/set_employee_status`,
        { employee_id, newStatus: "Approved", reason: "Approved" },
        {
          headers: {
      ...
      if (response.status === 200) {
        console.log(
          "Success in approving the application:",
          response.data.message
        );
      } else {
        console.log(
          "Fail in approving the application:",
          response.data.message
        );
      }
    } catch (error) {
  ...
  const handleReject = async () => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:8080/api/set_employee_status`,
        { employee_id, newStatus: "Rejected", reason: rejectReason },
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user_token}`,
      ...
      if (response.status === 200) {
        console.log(
          "Success in rejecting the application:",
          response.data.message
        );
      } else {
        console.log(
          "Fail in rejecting the application:",
          response.data.message
        );
      }
    } catch (error) {
    ...
    const fetchProfile = async () => {
      try {
        ...
        if (response.status === 200) {
          ...
          setIsCitizen(
            profile.employment.visa === "citizen" ||
              profile.employment.visa === "greenCard"
              ? "Yes"
              : "No"
          );
      ...
      {isLoading ? (
        ...
        <div className="onboarding-application">
          {!is_hr && step === "Rejected" && (
            <>
              <div
                className="custom-textbox-rejected d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mt-4"
                onClick={() => {
                  setShowFeedback(true);
                }}
              >
                Your previous application was rejected. Please click here for
                the feedback and resubmit your application.
              </div>
          ...
          {!is_hr && step === "Pending" && (
            <div className="custom-textbox-pending mt-4">
              This application is currently pending. You can download files by
              clicking those round image areas.
            </div>
          )}

          <h2 style={{ textAlign: "center", paddingTop: "10vh" }}>
          ...
          <Container className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <Row>
              <Col xs={12} md={6} xl={10}>
                ...
                >
                  <Card.Body>
                      ...
                      <Col className="mb-3">
                        <div>
                          ...
                          >
                            <Modal.Header closeButton>
                              {step === "Pending" ? (
                                <Modal.Title>Download or View</Modal.Title>
                              ) : (
                            ...
                            <Modal.Footer>
                              ...
                              <Modal
                                show={showLargeImage}
                                onHide={() => setShowLargeImage(false)}
                              >
                                <Modal.Header closeButton>
                        ...
                        <Form.Group id="apt">
                          ...
                          <Form.Control
                            ...
                            onChange={(e) => {
                              ...
                              localStorage.setItem("apt", e.target.value);
                            }}
                          />
                        </Form.Group>
                      </Col>
                        ...
                        <Form.Group id="cell-phone">
                          ...
                          <Form.Control
                            ...
                            onChange={(e) => {
                              ...
                              localStorage.setItem("cellPhone", e.target.value);
                            }}
                        ...
                        <Form.Group id="work phone">
                          ...
                          <Form.Control
                            ...
                            onChange={(e) => {
                              ...
                              localStorage.setItem("workPhone", e.target.value);
                            }}
                            placeholder="xxx-xxx-xxxx"
                            readOnly={
                              is_hr || step === "Pending" ? true : false
                    ...
                    <Row>
                      ...
                      {!is_hr && step !== "Pending" && isCitizen === "yes" && (
                        <Col className="mb-3">
                          <Form.Group className="mb-2">
                      ...
                      {!is_hr && step !== "Pending" && isCitizen === "no" && (
                        <Col className="mb-3">
                          <Form.Group className="mb-2">
                            <Form.Label>Auth Type</Form.Label>
                            <Form.Select
                          ...
                          <Col className="mb-3">
                            <Form.Group id="comment-title">
                              ...
                              <Form.Control
                                ...
                                value={finalVisa}
                                onChange={(e) => {
                                  setFinalVisa(e.target.value);
                                  console.log(finalVisa);
                                  localStorage.setItem(
                                    "finalVisa",
                                    e.target.value
                                  );
                    ...
                    <Row>
                      <Col className="mb-3">
                        <Form.Group id="ref-first-name">
                          ...
                          <Form.Control
                            ...
                            value={refFirstName}
                            onChange={(e) => {
                              setRefFirstName(e.target.value);
                              localStorage.setItem(
                                "refFirstName",
                                e.target.value
                              );
                      ...
                      <Col className="mb-3">
                        <Form.Group id="ref-middle-name">
                          <Form.Label>
                            Reference Middle Name (Optional)
                          </Form.Label>
                          <Form.Control
                            type="text"
                            readOnly={
                            ...
                            value={refMiddleName}
                            onChange={(e) => {
                              setRefMiddleName(e.target.value);
                              localStorage.setItem(
                                "refMiddleName",
                                e.target.value
                              );
                    ...
                    <Row>
                      <Col className="mb-3">
                        <Form.Group id="ref-phone-number">
                          <Form.Label>
                            Reference Phone Number (Optional)
                          </Form.Label>
                          <Form.Control
                            required
                            type="text"
                            ...
                            onChange={(e) => {
                              ...
                              localStorage.setItem("refPhone", e.target.value);
                            }}
                            placeholder="xxx-xxx-xxxx"
                          />
                        </Form.Group>
                        ...
                        <Form.Group id="ref-email">
                          ...
                          <Form.Control
                            ...
                            onChange={(e) => {
                              ...
                              localStorage.setItem("refEmail", e.target.value);
                            }}
                            placeholder="prefix@mail.suffix"
                          />
                        </Form.Group>
                      ...
                      <Col className="mb-3">
                        <Form.Group id="ref-relationship">
                          ...
                          <Form.Control
                            ...
                            onChange={(e) => {
                              setRefRelationship(e.target.value);
                              localStorage.setItem(
                                "refRelationship",
                                e.target.value
                              );
                                ...
                                <Dropdown.Menu>
                                  {is_hr ||
                                    (step === "Pending" && (
                                      <Dropdown.Item
                                        onClick={() =>
                                          handleDownload(DLBase64, DLFileName)
                                        }
                                      >
                                        Download
                                      </Dropdown.Item>
                ...
                {!is_hr && (step === "UnSubmitted" || step === "Rejected") && (
                  <div
                    style={{
                      display: "flex",
          ...
          {is_hr && step === "Pending" && (
            <Container className="d-flex justify-content-between align-items-center pb-4">
              <Row>
                <Col>
                  <Button
                    variant="primary"
